...
import { PublicGalleryItem, PublicProduction, PublicSiteSettings } from '../../../core/models/public.models';
...
@Component({selector:'app-public-fundus-detail',standalone:true,imports:[CommonModule,RouterLink,PublicGalleryLightboxComponent],templateUrl:'./public-fundus-detail-view.html',styleUrl:'./public-fundus-detail-view.scss'})
