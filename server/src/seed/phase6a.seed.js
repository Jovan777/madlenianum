...
const runPhase6ASeed = async () => {
  ...
  const rentalSpaces = await Promise.all([
    upsertRentalSpace({
      ...
      shortDescription: "Reprezentativna sala za konferencije, promocije i scenske dogadjaje.",
      description: "<p>Velika scena Madlenianuma pogodna je za vece korporativne, kulturne i protokolarne dogadjaje.</p>",
      ...
      areaSqm: 820,
      amenities: ["gledaliste", "foaje", "garderoba", "biletarnica"],
      technicalEquipment: ["rasveta", "ozvucenje", "projekcija"],
    ...
    upsertRentalSpace({
      title: "Foaje Madlenianuma",
      slug: "foaje-madlenianuma",
      shortDescription: "Elegantan prostor za prijeme, koktele i izlozbe.",
      description: "<p>Foaje je pogodan za susrete sa publikom, prijeme, izlozbe i manja predstavljanja.</p>",
      ...
      areaSqm: 260,
      amenities: ["foaje", "garderoba", "bar"],
      technicalEquipment: ["mobilno ozvucenje", "osnovna rasveta"],
